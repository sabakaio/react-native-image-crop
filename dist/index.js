...
var Crop = (function (_super) {
    ...
    Crop.prototype.render = function () {
        return (React.createElement(react_native_1.View, { style: [styles_1.default.container, this.state.containerStyle] },
            React.createElement(react_native_1.Image, { source: { uri: this.props.image }, style: styles_1.default.image, resizeMode: "contain", onLayout: this.adjustSize },
